...
from cs336_systems.distributed import (
    DistributedDataParallelBucketed,
    DistributedDataParallelIndividualParameters,
)
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    """
    return DistributedDataParallelIndividualParameters(module)
...
def get_ddp_bucketed(module: torch.nn.Module, bucket_size_mb: float) -> torch.nn.Module:
    ...
    Returns:
        Instance of a DDP class.
    """
    return DistributedDataParallelBucketed(module, bucket_size_mb=bucket_size_mb)
